...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Rodrigo", "DesarrolloTP1", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Desarrollo TP1";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Desarrollo TP1", null, { width: 640, height: 480 });
